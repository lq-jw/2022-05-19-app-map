...
import newmapStyle from "../mapStyles/newmapStyle.json"
      ...
      <Box flex={1}>
         ...
         >
            {(zoomRatio > 0.14) && metro.map((site) => (
               ...
               >
                  <Center bg="white" borderRadius={60} p={3 * zoomRatio+5} borderWidth={2 * zoomRatio} borderColor="black">
                     <Icon name={"bus"} size={30 * zoomRatio} color="#6C94EB"/>
                  </Center>
               </Marker>
            ))}
